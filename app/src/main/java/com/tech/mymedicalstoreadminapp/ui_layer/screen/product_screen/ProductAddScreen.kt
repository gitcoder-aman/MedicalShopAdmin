...
fun ProductAddScreen(
    ...
    val productAddResponseState = productViewmodel.addProductResponseState.collectAsState()
    val productAddScreenState = productViewmodel.addProductScreenData.collectAsState()
    ...
    Box(
        ...
        Column(
            ...
            AddItemButton("Add Product") {
                ...
                if(productAddScreenState.value.productImage.value != null) {

                    val imageFile =
                        getFileFromUri(context, productAddScreenState.value.productImage.value!!)
...
@Composable
fun SelectItemImageSection(productAddScreenState: State<ProductAddUpdateScreenState>) {
